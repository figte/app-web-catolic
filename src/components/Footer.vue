              ...
              <ul class="popular-post">
                <li>
                  <img
                    ...
                    alt="02"
                  />
                  <a href="#" title="Collaboratively coordinate."
                    >Collaboratively coordinate.</a
                  >
                  <br />
                  <i class="fa fa-calendar-o"></i>
                  <time class="post-meta-element" datetime="2015-09-10"
                ...
                <li>
                  <img
                    ...
                    alt="03"
                  />
                  <a href="#" title="Quickly develop exceptional"
                    >Quickly develop exceptional</a
                  >
                  <br />
                  <i class="fa fa-calendar-o"></i>
                  <time class="post-meta-element" datetime="2015-09-10"
                ...
                <li>
                  <img
                    ...
                    alt="01"
                  />
                  <a href="#" title="Why you need Peace WordPress Theme?"
                    >Why you need Peace WordPress Theme?</a
                  >
                  <br />
                  <i class="fa fa-calendar-o"></i>
                  <time class="post-meta-element" datetime="2015-09-10"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="copyright">
              <p>
                Copyright © 2015
                <a href="http://themes.codexcoder.com/peace">Peace</a> |
                Designed by <a href="http://codexcoder.com">CodexCoder</a>
              </p>
            </div>
            <!-- .copyright -->
          </div>
